		...
		<div style="margin-bottom: 1%;">
			...
			<div>
				<ul class="nav nav-pills nav-justified ">
					...
					<li class="active"><a href="../parent">학부모관리</a></li>
					<li><a href="">관리</a></li>
				...
				<div class="panel-body">
					<form role="form" action="" method="post">
						<div class="form-group">
							<c:choose>
								<c:when test="${searchModel.memberInfo.imageUrl!=null}">
									<img src="${searchModel.memberInfo.imageUrl}" class="img-thumbnail" width="160px" height="160px">								
								</c:when>
								<c:otherwise>
